...
function validarCPF(cpf) {
    return cpf.length === 11 && /^\d+$/.test(cpf); // Verifica se possui 11 dígitos numéricos
}
        ...
        if (evento) {
            ...
            if (cpfExistente) {
                ...
                if (evento.participantes.length >= evento.capacidade) {
                    ...
                    // Atualizar a lista de eventos para mostrar o novo total de participantes
                    carregarEventos();
                }
            }
        }
